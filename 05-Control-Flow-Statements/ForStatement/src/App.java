public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 2; i < 9; i++) {
            // System.out.println("10,000 at 2% interest = " + calculateInterest(10000.00,
            // (double) i));
            // System.out.println("10,000 at " + i + "% interest = " +
            // calculateInterest(10000.00, i));

            // String.format cuts extra numbers
            System.out.println(
                    "10,000 at " + i + "% interest = " + String.format("%.2f", calculateInterest(10000.00, i)));
        }
